							...
							<div class="col-xs-12">
								...
								<div>
									<h3 class="text-center">Product Name:- &nbsp;
										${cartLine.product.name}</h3>
									<br>
									<h4 class="text-center">Quantity :-
										&nbsp;&nbsp;${cartLine.productCount}</h4>
									<br>
									<h4 class="text-center">Buying Price :- &nbsp;&nbsp;
										&#8377; ${cartLine.buyingPrice}/-</h4>
								</div>

								<div class="text-right">
									<div class="panel-footer" id="loginpf">
										<h2>
											<strong>Grand Total :- &#8377; ${cartLine.total}/-</strong>
										</h2>
									</div>
								</div>
							</div>
